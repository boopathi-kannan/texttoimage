...
const GeneratedBtn = () => {
  ...
  return (
    <motion.div className='pb-16 text-center'>
      <h1 className='text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold text-nautral-800 py-6 md:py-16'  initial={{opcity:0.2,y:100}}
    transition={{duration:1}} whileInView={{opacity:1,y:0}} viewport={{once:true}}>See the magic. Try now</h1>
